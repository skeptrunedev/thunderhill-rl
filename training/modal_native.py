...
image = (
    ...
    .run_commands(
        "apt-get update && apt-get install -y --allow-change-held-packages libnccl-dev=2.26.2-1+cuda12.8 libnccl2=2.26.2-1+cuda12.8"
    )
    ...
    .env(
        {
            ...
            "THUNDERHILL_AGENT_OFFSCREEN": "1",
            "TOKENIZERS_PARALLELISM": "false",
            "THUNDERHILL_RENDERING_METHOD": "mobile",
        }
    )
)
...
def prepare_checkpoint():
    ...
    release = Path(
        "/model-cache/hub/models--nvidia--Alpamayo-1.5-10B/snapshots/7aba8293c09993f2e125c6819df05d7fa3e873ea"
    )
    processor = Path(
        "/model-cache/hub/models--nvidia--Cosmos-Reason2-8B/snapshots/a9fae2cf89dc64db96b12860417f0eb403013bb9"
    )
