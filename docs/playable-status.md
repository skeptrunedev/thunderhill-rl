...
* Explicit 120 Hz simulation, an assisted reduced order motorcycle model, configurable estimated parameters, and recorded requested and applied inputs. Version 3 solves current step longitudinal axle force balance, supports signed rollback, and balances stationary braking without fictional deceleration. Independent analytical tests cover these changes; this remains a reduced model.
